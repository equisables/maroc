...
class Hello(object):
	...
	if climat == "oasis" or climat == "plateaux" or climat == "plaines" or climat == "montagnes" or climat == "paysage":
	...
	elif (qui == "followers" or qui == "réputé"):
	...
	elif (qui == "insta" or qui == "instagram" or qui == "photos de la 4L" or qui == "photos de toi"):
	...
	if coming_intent == 'equisables:Pub':
	    self.Pub_callback(hermes, intent_message)
	if coming_intent == 'equisables:Solidarite':
	    self.Solidarite_callback(hermes, intent_message)
	if coming_intent == 'equisables:Equipage':
	    self.Equipage_callback(hermes, intent_message)
	if coming_intent == 'equisables:Personnalite':
