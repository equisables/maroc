...
class Hello(object):
	...
	if qui == "followers" or qui == "réputé":
	...
	if qui == "insta" or qui == "instagram" or qui == "photos de la 4L" or qui == "photos de toi":
